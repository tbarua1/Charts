...
public class GraphTopup extends AppCompatActivity {
    private String url = "http://192.168.0.200:8282/BHT//GraphTopup";
...
//{"completed":1568,"ongoing":2263,"scheduled":0,"projected":0}
    ...
    private ArrayList<BarDataSet> getDataSet() {
        ...
        BarEntry v1e1 = new BarEntry(getSetTopup.getCompleted(), 0); // Jan
        valueSet1.add(v1e1);
        BarEntry v1e2 = new BarEntry(getSetTopup.getOngoing(), 1); // Feb
        valueSet1.add(v1e2);
        BarEntry v1e3 = new BarEntry(getSetTopup.getProjected(), 2); // Mar
        valueSet1.add(v1e3);
