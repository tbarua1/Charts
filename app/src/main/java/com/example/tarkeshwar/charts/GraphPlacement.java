...
public class GraphPlacement extends AppCompatActivity {
    private String url="http://192.168.0.200:8282/BHT/PlacementServlet";
...
// creating data values
        ...
        entries.add(new Entry( getSetPlacementGraph.getITES(), 0));
        entries.add(new Entry(getSetPlacementGraph.getTOPUP(), 1));


        PieDataSet dataset = new PieDataSet(entries,"Placements");
